...
One is **Homoscedasticity**, which is tied to the independence of errors. In R, tests such as the **Breusch-Pagan Test**, **Koenker-Bassett Test**(also known as the Studentized Breusch-Pagan Test) or **White Test** are used to detect heteroscedasticity.
...
Another is **Normality of Errors**, which ensures that residuals are normally distributed is crucial for valid hypothesis testing and confidence intervals. In R, tests such as the **Jarque-Bera Test ** can be used.
