...
- The vacancy rate generally has a negative impact on housing values, with significant negative effects observed in Center City and parts of North and West Philadelphia. However, there is a localize area in the southern Center City where the vacancy rate has a positive impact on housing values.
- Single-family housing percentage positively impacts the median housing values, particularly in the northeast and northwest areas of Philadelphia.However, in some parts of the city, like the eastern Philadelphia, parts of the west and the south, the percentage of single-family housing has a negative impact on housing values.
- The percentage of residents with a bachelor's degree or higher has a positive impact on housing values across the city, with no areas showing a negative impact.
- The poverty rate generally has a negative effect on median housing values. This effect is more significant in southern, eastern, and northeastern parts of Philadelphia.
